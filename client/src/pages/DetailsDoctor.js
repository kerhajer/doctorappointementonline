...
useEffect(() => {
  dispatch(getdoctorinfobyid(idDoctor));
}, []);

const foundUser=useSelector(state=>state.AuthReducer.doctorUser)
        ...
        <div className="containerd">
            <div className="profile-header">
                <div className="profile-img">
                    <img src={foundUser.Image ? foundUser.Image.Image.imgUrl : (foundUser.Role == 'Doctor') ? "https://www.freeiconspng.com/thumbs/doctor-logo/doctor-pediatrician-icon-round-dr-logo-7.png" : 'https://upload.wikimedia.org/wikipedia/commons/d/d3/User_Circle.png'}
                        alt="Profile Image" />
                </div>
                <div className="profile-nav-info">
                    <h1 className="user-name">Dr. {foundUser.name} {foundUser.lastname} </h1>
                    <h1 id="state" className="state">{foundUser.specialization}  </h1>
                    <div className="address">

                        <small style={{marginLeft:'150px'}} id="state" className="state">    <i className="fas fa-map-marker-alt"></i> {foundUser.city}  </small><br></br>
                        <small id="state" className="state">    {foundUser.address}  </small>
            ...
            <div className="main-bd">
                <div className="left-side">
                    <div className="profile-side">
                        <p className="mobile-no"><i className="fa fa-phone"></i> {foundUser.phonenumber}   </p>
                        <p className="user-mail"><i className="fa fa-envelope"></i> {foundUser.email} </p>
                ...
                <div className="right-side">
                    ...
                    <div className="panel with-nav-tabs panel-info">
                     ...
                     <ul style={{height:'300px'}} className="nav nav-tabs">
                   <Calendar  idDoctor={idDoctor} /> 
